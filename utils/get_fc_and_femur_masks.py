def get_fc_and_femur_masks(seg_path, seg_fc&femur_path):
    ...
    if os.path.exists(seg_path):
        ...
        print(f'Saving femoral cartilage segmentation to {seg_fc&femur_path}')
        nib.save(seg_nii, seg_fc&femur_path)
    else:
